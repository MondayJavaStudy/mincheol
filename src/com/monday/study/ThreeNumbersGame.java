...
public class ThreeNumbersGame {
    ...
    private List<Integer> readLineForCards(Reader reader) throws IOException {
    ...
    private int readLineForNumber(Reader reader) throws IOException {
        BufferedReader br = new BufferedReader(reader);
        return Integer.parseInt(br.readLine());
    }

    public Set<List<Integer>> collect(List<Integer> cards, int expectNumber) {
